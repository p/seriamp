  ...
  module Yamaha
    module Protocol
      module Methods
        ...
        def zone3_volume_up
          remote_command('7AFD').state.fetch(:zone3_volume)
        end

        def zone3_volume_down
          remote_command('7AFE').state.fetch(:zone3_volume)
        end
        ...
        def get_main_volume_text
          system_command("2001", expect_response_cls: Response::TextResponse).text
        end

        def get_zone2_volume_text
          system_command("2002", expect_response_cls: Response::TextResponse).text
        end

        def get_zone3_volume_text
          system_command("2005", expect_response_cls: Response::TextResponse).text
        end
